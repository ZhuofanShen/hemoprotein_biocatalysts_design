...
# title = "$1^{st}$ iteration of design"
...
# title = "$2^{nd}$ iteration of design"
site_aas_list = {"29": {"I", "V", "N", "D"}, "64": {"V", "T", "A"}, "68": {"L", "F", "H"}}
# ylabel = "multi–state design fitness"
# yticks = [0, 50, 100, 150]
# ytick_labels = ["0", "50", "100", "150"]
# ylabel = "positive design fitness"
# yticks = [0, 5, 10]
# ytick_labels = ["0", "5", "10"]
# ylabel = "stability"

# title = "$3^{rd}$ iteration of design"
# site_aas_list = {"29": {"I", "V", "N", "D"}, "64": {"V", "T", "A"}, "68": {"L", "F", "H"}}
# ylabel = "multi–state design fitness"
# yticks = [0, 50, 100]
# ytick_labels = ["0", "50", "100"]
# ylabel = "positive design fitness"
# ylabel = "stability"
...
# round2 benzofuran
site_aas_list = {"126": {"Y"}, "163": {"F", "G"}, "164": {"F", "Y", "W", "L", "I", "P"}}
ylabel = "multi–state design fitness ($10^{4}$)"
yticks = [0, 10000, 20000]
ytick_labels = ["0", "1", "2"]
# ylabel = "positive design fitness"
